...
void load_character_data_ST2(skeleton_structure& skeleton, skinning_structure& skinning, vcl::mesh_drawable& shape_visual, vcl::timer_interval& timer, GLuint shader);

void load_xwing(vcl::mesh_drawable& shape_visual, GLuint shader);
