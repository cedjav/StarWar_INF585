...
struct skeleton_structure
{
    ...
    //vcl::buffer<joint_geometry>     rest_pose_ST2;          // Pour avoir aussi celle de mon perso à moi
...
struct scene_model : scene_base
{
    ...
    skeleton_structure skeleton,skeleton_ST2;
    skinning_structure skinning,skinning_ST2;
    vcl::mesh_drawable character_visual, character_visual_ST2;
